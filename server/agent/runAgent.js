...
function systemPrompt(role) {
  ...
  return [
    ...
    '',
    'TAKING ACTIONS (write tools — create_learning_path, book_mentorship_session, rewrite_resume, generate_document):',
    ...
    '- To CREATE A DOCUMENT/FILE: call generate_document with a title, format (pdf/docx/md), and the full content as markdown. Never claim a file exists unless a generate_document call returned an artifact id in this response.',
